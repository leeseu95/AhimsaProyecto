                ...
                <div className="wrapper row3">
                    <main className="container clear">
                        <div className="wrapper row3">
                            ...
                            <div id="info">
                                <h4 className="uppercase btmspace-50">USER PROFILE</h4>
                                <div className="square center article">
                                    ...
                                    <br/>
                                    <h3 id="titulo" value="0">User: {firebase.auth().currentUser.displayName}</h3>
                                    <br/>
                                    <p id="contenido" value="0">Joined Ahimsa on: {firebase.auth().currentUser.metadata.creationTime}</p>
                                    <br/>
                                    <p id="contenido" value="0">Last signed on: {firebase.auth().currentUser.metadata.lastSignInTime}</p>
                                    <br/>
                                </div>
                            </div>
                        </div>
